    ...
    (i.fn.particlesUpdate = function () {
      for (var e = 0; e < i.particles.array.length; e++) {
        ...
        if (
          ...
          var n = { x_left: a.radius, x_right: i.canvas.w, y_top: a.radius, y_bottom: i.canvas.h };
        else
          n = { x_left: -a.radius, x_right: i.canvas.w + a.radius, y_top: -a.radius, y_bottom: i.canvas.h + a.radius };
        if (
          (a.x - a.radius > i.canvas.w
            ? ((a.x = n.x_left), (a.y = Math.random() * i.canvas.h))
            : a.x + a.radius < 0 && ((a.x = n.x_right), (a.y = Math.random() * i.canvas.h)),
          a.y - a.radius > i.canvas.h
            ? ((a.y = n.y_top), (a.x = Math.random() * i.canvas.w))
            : a.y + a.radius < 0 && ((a.y = n.y_bottom), (a.x = Math.random() * i.canvas.w)),
          'bounce' === i.particles.move.out_mode)
        )
    ...
    (i.fn.interact.linkParticles = function (e, a) {
      ...
      if (s <= i.particles.line_linked.distance) {
        var r =
          ...
          s / (1 / i.particles.line_linked.opacity) / i.particles.line_linked.distance;
        if (r > 0) {
          ...
          if (n >= 0 && 'mousemove' == i.interactivity.status) {
            ...
            if (i.interactivity.modes.bubble.opacity != i.particles.opacity.value)
              if (i.interactivity.modes.bubble.opacity > i.particles.opacity.value)
                ...
                (o = e.opacity - (i.particles.opacity.value - i.interactivity.modes.bubble.opacity) * n) < e.opacity &&
                  o >= i.interactivity.modes.bubble.opacity &&
                  (e.opacity_bubble = o);
          }
        } else s();
        ...
        function p(a, t, n, s, r) {
          if (a != t)
            if (i.tmp.bubble_duration_end)
              null != n &&
                ((o = a + (a - (s - (v * (s - a)) / i.interactivity.modes.bubble.duration))),
    ...
    (i.fn.modes.repulseParticle = function (e) {
      if (
        ...
        var a = e.x - i.interactivity.mouse.pos_x,
          ...
          s = { x: a / n, y: t / n },
          r = clamp(
            (1 / (o = i.interactivity.modes.repulse.distance)) * (-1 * Math.pow(n / o, 2) + 1) * o * 100,
            0,
            50
          ),
      ...
      if (i.interactivity.events.onhover.enable && 'mousemove' == i.interactivity.status) {
        ...
        if (n <= i.interactivity.modes.grab.distance) {
          var s =
            ...
            n / (1 / i.interactivity.modes.grab.line_linked.opacity) / i.interactivity.modes.grab.distance;
          if (s > 0) {
